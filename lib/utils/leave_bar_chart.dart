...
class LeavesBarChart extends StatefulWidget {
  const LeavesBarChart({super.key});
  final Color leftBarColor = redBg;
  final Color rightBarColor = yellowBg;
  final Color avgColor = greenBg;
  @override
  State<StatefulWidget> createState() => LeavesBarChartState();
}

class LeavesBarChartState extends State<LeavesBarChart> {
